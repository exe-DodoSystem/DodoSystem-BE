...
namespace SMEFLOWSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260803160615_RemoveBillingOrderDiscountColumns")]
    partial class RemoveBillingOrderDiscountColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SMEFLOWSystem.Core.Entities.RawPunchLog", b =>
                {
                    ...
                    b.HasIndex("TenantId", "EmployeeId", "ClientRequestId")
                        .IsUnique()
                        .HasDatabaseName("UX_RawPunchLogs_Tenant_Employee_ClientRequestId")
